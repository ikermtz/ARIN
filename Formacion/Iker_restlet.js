 ...
 */
 ...
 function(n_record, n_log, n_search, n_error) {
        ...
        for (param in payload){
            ...
            if(mov != null){
                ...
                // Existe el usuario    
                    ...
                    existe(mov, concepto, importe, fecha, user, usuario);
    ...
    function existe(mov, concepto, importe, fecha, user, usuario){
        
        var saldo = usuario.getValue({fieldId: 'custrecord_ai_registroej1_saldo'});
        ...
        // Saldo suficiente
            ...
            generarMovimiento(mov, concepto, importe, fecha, user, saldo, usuario);
    ...
    function generarMovimiento(mov, concepto, importe, fecha, user, saldo, usuario){
        ...
        // Actualizamos saldo
        usuario.setValue({fieldId: 'custrecord_ai_registroej1_saldo', value: saldo});
